        ...
        <div className='w-full flex px-[7.5%] pb-48'>
            <div className='flex flex-col w-full gap-16 md:flex-row'>
                ...
                <div className='flex flex-col w-full text-base/[250%] text-stone-700 tracking-wide text-justify font-manrope'>
                    <div className='flex flex-wrap pb-2 text-2xl font-bold uppercase border-b-2 text-sky-900 border-stone-200 w-max font-merriwether'>Siddartha Smarak Secondary School</div>
                    ...
                    <button className='flex px-4 py-1 mt-8 text-white bg-orange-500 hover:bg-orange-400 rounded-xl font-merriwether w-max'>Read More</button>
                </div>
            </div>
        </div>
    )
