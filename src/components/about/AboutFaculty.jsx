...
const AboutFaculty = () => {
    return (
        <div className='w-full pb-28 px-[5%] flex' >
...
const Staff = ({ staff }) => {
    return (
        <div data-aos='fade-up' data-aos-delay={staff.delay} key={staff.id} className='flex flex-col w-full sm:w-[45%] md:w-[30%] bg-white shadow-lg rounded-2xl overflow-hidden'>
            <img className='flex object-cover object-center w-full h-80 ' src={staff.url} alt="" />
