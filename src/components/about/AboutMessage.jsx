    ...
    return (
        <div className='w-full px-[5%] flex pb-28 relative'>
            ...
            <div className='flex flex-col gap-4'>
                <div className='w-full pb-2 text-2xl font-bold text-center uppercase border-b-2 md:text-start md:w-max text-sky-900 border-stone-200 font-merriwether'>Message from the Principal</div>
                <div className='flex flex-col w-full gap-12 md:gap-32 md:flex-row'>
                    ...
                    <div className='flex order-1 w-full h-full shadow-lg md:order-2 ' >
